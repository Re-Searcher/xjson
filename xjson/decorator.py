""" file: decorator.py (xjson.metadata)
    author: Jess Robertson
            CSIRO Earth Science and Resource Engineering
    email:  jesse.robertson@csiro.au
    date:   Wednesday May 1, 2013

    description: Some basic metaclasses etc for defining xjson classes
"""

from __future__ import print_function, division

from .metadata import Metadata, XJSON_NAMESPACE
...
def with_metadata(tag, subelements=None):
    ...
    def _md_wrapper(cls):
        ...
        cls.metadata = Metadata(tag=XJSON_NAMESPACE + tag,
                                ident=cls.ident)
